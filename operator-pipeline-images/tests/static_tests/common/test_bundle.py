...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            [
                bundle_files("hello", "0.0.1"),
                {"operators/hello/ci.yaml": {"key": "value"}},
            ],
            ("hello", "0.0.1"),
            {
                (
                    ...
                    "which does not comply with the schema: "
                    "'fbc' is a required property",
                ),
            },
            id="Testing validation without fbc object",
        ),
        pytest.param(
            [
                bundle_files("hello", "0.0.1"),
        ...
        pytest.param(
            ...
            id="Testing with missing required fields in catalog_mapping array",
        ),
        pytest.param(
            [
                bundle_files("hello", "0.0.1"),
